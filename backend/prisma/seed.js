...
const handleHashing_1 = require("../src/utils/handleHashing");
...
async function main() {
    ...
    const createdCategories = await Promise.all(categories.map((categoryName) => prisma.category.create({
    ...
    const user = await prisma.user.create({
        data: {
            ...
            password: await (0, handleHashing_1.hashPassword)('test123'),
            points: 175,
            quizResults: {
                create: [
    ...
    const user2 = await prisma.user.create({
        data: {
            ...
            password: await (0, handleHashing_1.hashPassword)('ivana123'),
            points: 120,
        },
    });
    const user3 = await prisma.user.create({
        data: {
            ...
            password: await (0, handleHashing_1.hashPassword)('marko123'),
            points: 60,
        },
    });
    const admin = await prisma.user.create({
        data: {
            ...
            password: await (0, handleHashing_1.hashPassword)('admin123'),
            role: 'Admin',
        },
    });
